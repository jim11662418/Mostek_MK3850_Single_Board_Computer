...
;=========================================================================
; Monitor firmware for the 3850 Single Board Computer.
;
...
output1:    pi get2hex     ; get the port address
            lr A,rxbuffer
            ni 01H         ; mask all but bit 0 (valid port addresses for MK3850 are 0-1)
            lr portaddr,A  ; save the port address
...
;-----------------------------------------------------------------------------------
; transmit the character in 'txbuffer' through the serial port
;-----------------------------------------------------------------------------------
putc:       lis 8
            lr bits,A
            li 01H
